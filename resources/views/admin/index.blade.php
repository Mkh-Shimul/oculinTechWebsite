...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.html">Oculin Tech Admin Panel </a>
            <div class="nav-collapse">
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                                class="icon-user"></i> {{ $data->email }} <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <ul class="messages_layout">
                                <li class="from_user left"> <a href="#" class="avatar"><img src="{{ asset('adminassets/img/message_avatar1.png') }}"/></a>
                                ...
                                <li class="by_myself right"> <a href="#" class="avatar"><img src="{{ asset('adminassets/img/message_avatar2.png') }}"/></a>
                                    <div class="message_wrap"> <span class="arrow"></span>
                                ...
                                <li class="from_user left"> <a href="#" class="avatar"><img src="{{ asset('adminassets/img/message_avatar2.png') }}"/></a>
                                    <div class="message_wrap"> <span class="arrow"></span>
...
<div class="footer">
    <div class="footer-inner">
        <div class="container">
            <div class="row">
                <div class="span12"> &copy; {{ date('Y') }} <a href="#">Oculin Tech BD Ltd.</a>. </div>
                <!-- /span12 -->
            </div>
            <!-- /row -->
        </div>
